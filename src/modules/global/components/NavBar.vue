	...
	<nav
		...
		<div class="container flex flex-wrap items-center justify-between mx-auto">
			...
			<div
				...
				id="mobile-menu-2">
				<ul
					class="flex flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700 main-navbar">
					<li>
						<router-link
							:to="{ name: 'home' }"
...
<script setup lang="ts">
	import { useUserStore } from '@/modules/events/store/UseStore';
